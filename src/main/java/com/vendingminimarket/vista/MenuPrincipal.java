...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    public MenuPrincipal(String nombre, String rol, int idUsuario) {
        this.nombre = nombre;
        this.rol = rol;
    ...
    private void btnPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPedidosActionPerformed
        new GestionPedidos(nombre, rol, idUsuario).setVisible(true);
    ...
    private void btnMaquinasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaquinasActionPerformed
        new GestionMaquinas(nombre, rol, idUsuario).setVisible(true);
        this.dispose();
